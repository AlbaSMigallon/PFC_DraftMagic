...
/*
 * Clase utulizada para generar los sobres en la fase de draft
 */
public class GeneradorSobres {
	...
	private ArrayList<Carta> filtrarCartasPorRareza(String... rarezas) {
		...
		return cartas.stream().filter(carta -> rarezasList.contains(carta.getRareza()))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	/*
	 * Aniade las cartas por estadistica de seen
	 */
